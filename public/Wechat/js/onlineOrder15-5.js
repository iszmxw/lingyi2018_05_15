...
function ress_list_box(ress_info,realname,mobile,status,address_id){
    ...
    str += '<div class="row alert_list">'+
        ...
        if(status && status == 1){
            str += '<input type="radio" id="userinfo'+address_id+'" value="'+address_id+'" name="dizhi" checked="checked" class="radio_address">'+
            '<label for="userinfo'+address_id+'">';
        }else{
            str += '<input type="radio" id="userinfo'+address_id+'" value="'+address_id+'" name="dizhi" class="radio_address"><label for="userinfo11'+address_id+'">';
        }
