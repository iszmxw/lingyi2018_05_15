...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/Wechat')}}/css/public/light7.min.css?v=<?php echo time(); ?>">
...
<div class="page">
    ...
    <div class="cart_bottom">
        <div class="cart_fl">
            ...
            <div class="cart_right"><a href="http://develop.01nnt.com/zerone/wechat/order_check">去结算<i></i></a></div>
        </div>
    </div>
    <!-- alert -->
...
<script type='text/javascript' src="{{asset('public/Wechat')}}/js/goodslist.js?v=<?php echo time(); ?>"
